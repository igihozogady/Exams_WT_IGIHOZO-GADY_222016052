...
<div class="page">
    ...
    <a href="./?page=add_Consultation" class="btn-download">
        <i class='bx bxs-cloud-download'></i>
        <span class="text">Add New Consultation</span>
    </a>
</div>
...
<div class="DataTable">
    ...
    <table>
        ...
        <tbody>
            <?php
            // Fetch data from the consultations table
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='./?page=add_Consultation&id=".$row["Id"]."'>Update</a> | <a href='delete.php?table=consultations&id=".$row["Id"]."' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>"; // Action buttons
                    echo "</tr>";
                }
            } else {
