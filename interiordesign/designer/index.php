...
<div class="page">
    ...
    <a href="./?page=add_Designer" class="btn-download">
        <i class='bx bxs-cloud-download'></i>
        <span class="text">Add New Designer</span>
    </a>
</div>
...
<div class="DataTable">
    ...
    <table>
        ...
        <tbody>
            <?php
            // Fetch data from the designers table
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='./?page=add_Designer&id=".$row["Id"]."'>Update</a> | <a href='delete.php?table=designers&id=".$row["Id"]."' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>"; // Action buttons
                    echo "</tr>";
                }
            } else {
